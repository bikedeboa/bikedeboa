...
$(() => {
  ...
  function openDetailsModal(marker) {
    ...
    ////////////////////////////////
    if (_isMobile) { 
      $('#placeDetailsPlaceholder_mobile').html(BDB.templates.placeDetailsContent(templateData));
    } else {
      $('#placeDetailsPlaceholder_desktop').html(BDB.templates.placeDetailsContent(templateData));
    }
