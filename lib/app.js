...
$(function () {
    ...
    /////////////////////////////////////////////////////////////
    // 
    var API_URL = 'http://a28139fc.ngrok.io'; //without final '/'
    // 
    /////////////////////////////////////////////////////////////
    ...
    function postReview(placeId, callback) {
        $.post(
            API_URL + '/checkin',
            {
                idLocal: placeId,
    ...
    function getAllPlaces(successCB, failCB, alwaysCB) {
        ...
        $.ajax({
            ...
            // @todo MOCK STUFF HEHEHEHEHEH
            console.warn("creating some shit from where"); 
            markers.forEach(function(m) {
                // m.average = (Math.floor(Math.random() * 40) + 10)/10;
                var randomStructure = Math.floor(Math.random() * 5) + 1; 
                switch(randomStructure) {
                    case 1: m.structureType = 'U Invertido'; break; 
                    case 2: m.structureType = 'De roda'; break;
                    case 3: m.structureType = 'Trave'; break;
                    case 4: m.structureType = 'Suspenso'; break;
                    case 5: m.structureType = 'Grade'; break;
                }
            });
    ...
    function openDetails(i) {
        ...
        var randomPic = Math.floor(Math.random() * NPICS) + 1; 
