...
$(function () {
    ...
    function updateMarkers() {
        ...
        if (markers && markers.length > 0) {
            ...
            for(var i=0; i<markers.length; i++) {
                ...
                var sizeMultiplier = 0.5 + (m.average/10);
                var icon = {
                  url: iconUrl, // url
                  scaledSize: new google.maps.Size((MARKER_W*sizeMultiplier), (MARKER_H*sizeMultiplier)), // scaled size
                  origin: new google.maps.Point(0, 0), // origin
                  anchor: new google.maps.Point((MARKER_W*sizeMultiplier)/2, (MARKER_H*sizeMultiplier)), // anchor
                };
                ...
                // Default gmaps marker
                // new google.maps.Marker({position: {lat: Number.parseFloat(m.lat), lng: Number.parseFloat(m.lng) }, map: map, });
    ...
    function sendReviewBtn() {
        postReview(openedMarker.id, currentPendingRating, function() {
    ...
    function postCheckinBtn() {
        postCheckin(openedMarker.id, function() {
            $('#placeDetailsModal').modal('toggle');
