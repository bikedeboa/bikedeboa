...
$(function () {
    ...
    var API_URL = 'http://cdcf7843.ngrok.io'; //without final '/'
    ...
    function getAllPlaces(successCB, failCB, alwaysCB) {
        ...
        $.ajax({
            ...
            markers.forEach(function(m) {
                m.average = Math.floor(Math.random() * 5) + 1  
            })
    ...
    function openDetails(i) {
        console.log(markers[i].text);
        console.log(markers[i].structureType);
        console.log(markers[i].isPublic);
    }
